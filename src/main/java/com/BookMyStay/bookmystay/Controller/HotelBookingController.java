...
import com.BookMyStay.bookmystay.Dto.BookingPaymentInitResponseDto;
import com.BookMyStay.bookmystay.Dto.BookingRequest;
import com.BookMyStay.bookmystay.Dto.BookingStatusResponseDto;
...
public class HotelBookingController {
    ...
    @Operation(summary = "Confirm local payment flow for the booking", tags = {"Booking Flow"})
    public ResponseEntity<BookingDto> confirmPayment(@PathVariable Long bookingId,
                                                     @RequestParam String sessionId) {
        return ResponseEntity.ok(bookingService.confirmPayment(bookingId, sessionId));
    }
